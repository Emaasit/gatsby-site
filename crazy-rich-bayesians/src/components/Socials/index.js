...
const Socials = () => (
  <div className='db dtc-ns black-70 tc tr-ns v-mid'>
    ...
    <a href='https://twitter.com/emaasit' className='link hover-light-blue dib mr3 black-70' target='_blank'
      rel='noopener nofollow noreferrer'>
    ...
    <a href='https://github.com/emaasit' className='link hover-black dib mr3 black-70' title='Vaibhav Sharma on Github'
      target='_blank'
      rel='noopener nofollow noreferrer'>
      <svg className='db w2 h2' role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'
        fill='currentColor'>
    ...
    <a href='https://www.linkedin.com/in/emaasit' className='link hover-blue dib black-70' target='_blank'
      rel='noopener nofollow noreferrer'>
