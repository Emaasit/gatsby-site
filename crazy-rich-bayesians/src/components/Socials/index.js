...
const Socials = () => (
  <div className='db dtc-ns black-70 tc tr-ns v-mid'>
    <a href={`feed:https://danielemaasit.com${config.siteRss}`} className='link hover-orange dib mr3 black-70'
      title='Crazy Rich Bayesians'
      target='_blank'
    ...
    <a href='https://twitter.com/emaasit' className='link hover-light-blue dib mr3 black-70' title='Daniel Emaasit on Twitter'
      target='_blank'
      rel='noopener nofollow noreferrer'>
    ...
    <a href='https://github.com/emaasit' className='link hover-black dib mr3 black-70' title='Daniel Emaasit on Github'
      target='_blank'
      rel='noopener nofollow noreferrer'>
      <svg className='db w2 h2' role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'
        fill='currentColor'>
    ...
    <a href='https://www.linkedin.com/in/emaasit' className='link hover-blue dib black-70' title='Daniel Emaasit on LinkedIn'
      target='_blank'
      rel='noopener nofollow noreferrer'>
